...
public class ArrayUtils {
    ...
    public static String[][] toPrimitive(List<String> arr) {
        ...
        String[][] result = new String[arr.size()][1];
    ...
    public static int[] toIntArrayList(List<Integer> list){
        // из List<Integer> можно получить Integer[]
        Integer[] arr = list.toArray(new Integer[0]);
        // Integer[] -> int[]
        return ArrayUtils.toPrimitive(arr);
    ...
    */
    ...
    public static String toOutString(String[][] arr) {
        if (arr == null) {
            return null;
        }
        StringBuilder sb = new StringBuilder();
    ...
    public static String toOutStringSolo(String[] arr) {
        if (arr == null) {
            return null;
        }
        StringBuilder sb = new StringBuilder();
    ...
    */
    ...
    public static void writeStringArrayToFile(String fileName, String[] arr)
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            out.println(toOutStringSolo(arr));
        }
    }
    ...
    public static String[][] readStringFile(String file) throws FileNotFoundException {
        ...
        sort(fArr);
        String[][] arr = new String[fArr.size()][1];
    ...
    public static void outputFile(String fileName, String[][] arr) throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            for (int i = 0; i < arr.length; i++)
                out.println(arr[i][0]);
        }
    ...
    public static String[] hashSetToString(HashSet<String> arr) {
        String[] arrNew = new String[arr.size()];
        int k = 0;
        for (String i : arr){
            arrNew[k] = i;
            k++;
    ...
    public static String[] String2DtoString(String[][] arr) {
    ...
    public static String[][] hashSetTo2DString(HashSet<String> arr) {
        String[] arrBeforeSort = new String[arr.size()];
        String[][] arrNew = new String[arr.size()][1];
        int k = 0;
        for (String i : arr){
            arrBeforeSort[k] = i;
            k++;
